...
from rent.verl.utils import gsm8k
...
def main_task(config):
    ...
    from rent.verl.utils import copy_to_local
    ...
    if config.actor_rollout_ref.actor.strategy == "fsdp":
        ...
        from rent.verl.workers import ActorRolloutRefWorker, CriticWorker
    ...
    if config.reward_model.enable:
        if config.reward_model.strategy == "fsdp":
            from rent.verl.workers import RewardModelWorker
