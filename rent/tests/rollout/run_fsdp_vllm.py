...
from rent.verl.third_party.vllm import LLM
...
def main():
    ...
    from rent.verl.utils.torch_functional import pad_sequence_to_length
    ...
    from rent.verl.workers.rollout.vllm_rollout import _pre_process_inputs
