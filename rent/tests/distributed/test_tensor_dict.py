...
from rent.verl.protocol import DataProto, all_gather_data_proto
...
def test_vocab_parallel_entropy():
    ...
    from rent.verl.utils.megatron.tensor_parallel import vocab_parallel_entropy
    from rent.verl.utils.torch_functional import entropy_from_logits
