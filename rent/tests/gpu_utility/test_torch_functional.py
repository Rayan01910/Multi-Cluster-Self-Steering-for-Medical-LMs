...
from rent.verl.utils.model import create_random_mask


def test_log_probs_from_logits_response_rmpad():
    from rent.verl.utils.torch_functional import log_probs_from_logits_response, log_probs_from_logits_response_rmpad
...
def test_logprobs_from_logits_v2(dtype):
    from rent.verl.utils.torch_functional import logprobs_from_logits_naive, logprobs_from_logits_v2
...
def test_lr_scheduler():
    ...
    from rent.verl.utils.torch_functional import get_cosine_schedule_with_warmup
