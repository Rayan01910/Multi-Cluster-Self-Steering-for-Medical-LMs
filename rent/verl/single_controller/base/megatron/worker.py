...
from rent.verl.single_controller.base.worker import DistGlobalInfo, DistRankInfo, Worker
...
class MegatronWorker(Worker):
    ...
    def _init_hf_config_and_tf_config(self, model_path, dtype, override_model_config):
        ...
        from rent.verl.models.mcore import hf_to_mcore_config
        from rent.verl.utils import hf_tokenizer
        from rent.verl.utils.fs import copy_to_local
        from rent.verl.utils.model import update_model_config
