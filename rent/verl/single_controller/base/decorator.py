...
from rent.verl.protocol import DataProtoFuture
...
def _split_args_kwargs_data_proto(chunks, *args, **kwargs):
    from rent.verl.protocol import DataProto, DataProtoFuture
...
def dispatch_megatron_compute(worker_group, *args, **kwargs):
    ...
    """
    from rent.verl.single_controller.base.megatron.worker_group import MegatronWorkerGroup
...
def dispatch_dp_compute(worker_group, *args, **kwargs):
    from rent.verl.single_controller.base.worker_group import WorkerGroup
