...
from rent import verl as verl_F
from rent.verl import DataProto
from rent.verl.single_controller.base import Worker
from rent.verl.single_controller.base.decorator import Dispatch, register
from rent.verl.utils import hf_processor, hf_tokenizer
from rent.verl.utils.checkpoint.fsdp_checkpoint_manager import FSDPCheckpointManager
from rent.verl.utils.debug import log_gpu_memory_usage
from rent.verl.utils.flops_counter import FlopsCounter
from rent.verl.utils.fs import copy_to_local
from rent.verl.utils.fsdp_utils import (
...
from rent.verl.utils.import_utils import import_external_libs
from rent.verl.utils.model import compute_position_id_with_mask
from rent.verl.workers.sharding_manager.fsdp_ulysses import FSDPUlyssesShardingManager
...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(
        ...
        from rent.verl.utils.model import get_generation_config, print_model_size, update_model_config
        from rent.verl.utils.torch_dtypes import PrecisionType
        ...
        with init_context(), warnings.catch_warnings():
            ...
            if use_remove_padding or self.ulysses_sequence_parallel_size > 1:
                from rent.verl.models.transformers.monkey_patch import apply_monkey_patch
        ...
        if role == "actor" and optim_config is not None:
            from rent.verl.utils.torch_functional import get_constant_schedule_with_warmup, get_cosine_schedule_with_warmup
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == "hf":
            from rent.verl.workers.rollout import HFRollout
            from rent.verl.workers.sharding_manager.base import BaseShardingManager
            ...
            from rent.verl.workers.rollout.vllm_rollout import vllm_mode, vLLMAsyncRollout, vLLMRollout
            from rent.verl.workers.sharding_manager.fsdp_vllm import FSDPVLLMShardingManager
            ...
            from rent.verl.workers.rollout.sglang_rollout import SGLangRollout
            ...
            from rent.verl.workers.sharding_manager.fsdp_sglang import FSDPSGLangShardingManager
            ...
            from rent.verl.workers.rollout.sglang_rollout import AsyncSGLangRollout
            from rent.verl.workers.sharding_manager.fsdp_sglang import FSDPAsyncSGLangShardingManager
    ...
    def init_model(self):
        from rent.verl.workers.actor import DataParallelPPOActor
...
class CriticWorker(Worker):
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        from rent.verl.utils.model import print_model_size
        from rent.verl.utils.torch_dtypes import PrecisionType
    ...
    def init_model(self):
        ...
        from rent.verl.workers.critic import DataParallelPPOCritic
...
class RewardModelWorker(Worker):
    ...
    def _forward_micro_batch(self, micro_batch):
        ...
        from rent.verl.utils.ulysses import gather_outpus_and_unpad, ulysses_pad_and_slice_inputs
    ...
    def compute_rm_score(self, data: DataProto):
        ...
        from rent.verl.utils.seqlen_balancing import get_reverse_idx, rearrange_micro_batches
