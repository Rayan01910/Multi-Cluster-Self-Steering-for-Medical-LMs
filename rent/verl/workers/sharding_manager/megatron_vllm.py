...
import rent.verl.utils.megatron.tensor_parallel as tp_utils
from rent.verl import DataProto
from rent.verl.models.mcore.weight_converter import McoreToHFWeightConverterBase
from rent.verl.third_party.vllm import LLM, vllm_version
from ...third_party.vllm.vllm_v_0_6_3 import parallel_state as vllm_ps
...
from rent.verl.utils.memory_buffer import (
    build_memory_buffer,
    build_memory_reference_from_module,
    get_weight_buffer_meta_from_module,
)
from rent.verl.utils.model import normalize_model_name
from rent.verl.utils.torch_functional import allgather_dict_tensors, check_cuda_is_available
from rent.verl.utils.vllm_utils import patch_vllm_moe_model_weight_loader
...
Consider using the `MegatronPPOActor` class directly as a replacement."
    ...
    def _build_param_buffer(self, pp_rank):
        ...
        if pp_rank == self._pp_rank:
            from rent.verl.utils.memory_buffer import MemoryBuffer
