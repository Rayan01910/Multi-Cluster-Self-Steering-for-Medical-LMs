...
from rent.verl.single_controller.base.megatron.worker import MegatronWorker
from rent.verl.utils import hf_tokenizer
from rent.verl.utils.checkpoint.megatron_checkpoint_manager import MegatronCheckpointManager
from rent.verl.utils.debug import GPUMemoryLogger, log_gpu_memory_usage
from rent.verl.utils.flops_counter import FlopsCounter
from rent.verl.utils.fs import copy_to_local
from rent.verl.utils.megatron_utils import (
    load_megatron_model_to_gpu,
    load_megatron_optimizer,
    offload_megatron_model_to_cpu,
    offload_megatron_optimizer,
)
from rent.verl.utils.model import load_mcore_dist_weights, load_megatron_gptmodel_weights
from rent.verl.workers.actor.megatron_actor import MegatronPPOActor
from rent.verl.workers.critic.megatron_critic import MegatronPPOCritic
from rent.verl.workers.reward_model.megatron.reward_model import MegatronRewardModel
...
class ActorRolloutRefWorker(MegatronWorker):
    ...
    def _build_model_optimizer(self, model_path, optim_config, override_model_config):
        ...
        from rent.verl.utils.megatron.optimizer import get_megatron_optimizer
        from rent.verl.utils.megatron_utils import get_model, init_megatron_optim_config
        from rent.verl.utils.model import get_generation_config, print_model_size

        self._init_hf_config_and_tf_config(model_path, self.dtype, override_model_config)
        self.generation_config = get_generation_config(self.local_path)

        def megatron_actor_model_provider(pre_process, post_process):
            from rent.verl.models.mcore import init_mcore_model
    ...
    def _build_rollout(self, trust_remote_code=False):
        if self.config.rollout.name == "vllm":
            ...
            from rent.verl.workers.rollout.vllm_rollout import vllm_mode, vLLMRollout
            from rent.verl.workers.sharding_manager.megatron_vllm import MegatronVLLMShardingManager
            ...
            from rent.verl.models.mcore import get_mcore_weight_converter
...
class RewardModelWorker(MegatronWorker):
    ...
    def _build_rm_model(self, model_path, override_model_config):
        ...
        from rent.verl.utils.megatron_utils import get_model
