...
from rent.verl.trainer.ppo.core_algos import agg_loss, compute_policy_loss, kl_penalty
from rent.verl.utils.debug import GPUMemoryLogger
from rent.verl.utils.debug.profile import Profiler
from rent.verl.utils.megatron.pipeline_parallel import make_batch_generator
from rent.verl.utils.megatron.tensor_parallel import vocab_parallel_entropy, vocab_parallel_log_probs_from_logits
from rent.verl.utils.megatron_utils import get_model_config
from rent.verl.utils.py_functional import append_to_dict
from rent.verl.utils.torch_functional import broadcast_dict_tensor, split_dict_tensor_into_batches
from rent.verl.workers.actor import BasePPOActor
...
class MegatronPPOActor(BasePPOActor):
    ...
    def forward_backward_batch(self, data: DataProto, forward_only=False, post_process_fn=None, calculate_entropy=False):
        ...
        def forward_step(batch_iter, model):
            ...
            from rent.verl.models.mcore import get_mcore_forward_fn
