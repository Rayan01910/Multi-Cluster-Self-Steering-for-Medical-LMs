...
from rent.verl.third_party.sglang import parallel_state as sglang_ps
from rent.verl.tools.base_tool import BaseTool
from rent.verl.tools.schemas import OpenAIFunctionParsedSchema, OpenAIFunctionToolCall
from rent.verl.utils.debug import GPUMemoryLogger
from rent.verl.utils.model import compute_position_id_with_mask
from rent.verl.utils.net_utils import is_ipv6
from rent.verl.utils.torch_functional import get_response_mask, pad_sequence_to_length
from rent.verl.workers.rollout.base import BaseRollout
from rent.verl.workers.rollout.schemas import (
    AsyncRolloutRequest,
    AsyncRolloutRequestStateEnum,
    FinishReasonTypeEnum,
    Message,
)
from rent.verl.workers.rollout.sglang_rollout.sglang_rollout import _post_process_outputs, _pre_process_inputs
        ...
        **kwargs,
        ...
        if config.multi_turn.tool_config_path is not None:
            ...
            def initialize_tools(tools_config) -> list:
                ...
                from rent.verl.tools.schemas import OpenAIFunctionToolSchema
