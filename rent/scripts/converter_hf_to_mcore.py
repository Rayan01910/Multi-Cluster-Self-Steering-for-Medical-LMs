...
from rent.verl.models import hf_to_mcore_config
from rent.verl.utils import get_model
...
def convert_hf_to_mcore(hf_model_path, output_path, test=False):
    ...
    def megatron_model_provider(pre_process, post_process):
        from rent.verl.models import init_mcore_model
    ...
    if test:
        ...
        def megatron_value_model_provider(pre_process, post_process):
            from rent.verl.utils.model import get_parallel_gptmodel_from_config
